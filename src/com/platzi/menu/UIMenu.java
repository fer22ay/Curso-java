...
import com.platzi.model.Patient;
...
public class UIMenu {
    ...
    public static void showMenu() {
        System.out.println("Welcome to My Appointements");
    ...
    private static void authUser(int userType) {
        ...
        doctors.add(new Doctor("Oscar Gramajo", "oscar@gmail.com"));
        doctors.add(new Doctor("Emily Sosa", "emily@gmail.com"));
        ...
        do {            
            System.out.println("Insert your email: [a@.com]");
            Scanner sc = new Scanner(System.in);
